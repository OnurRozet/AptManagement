    ...
    public partial class initialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_IncomeDebtAllocations", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.InsertData(
                table: "Apartments",
                columns: new[] { "Id", "Balance", "CreatedBy", "CreatedDate", "DeletedBy", "DeletedDate", "IsDeleted", "IsManager", "Label", "OpeningBalance", "OwnerName", "TenantName", "UpdatedBy", "UpdatedDate" },
                values: new object[] { 9, 0m, 0, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), 0, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), false, true, "Daire 9", 0m, "Onur Rozet", null, 0, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified) });

            migrationBuilder.InsertData(
                table: "Roles",
                columns: new[] { "Id", "ConcurrencyStamp", "Name", "NormalizedName" },
                values: new object[] { new Guid("b2c3d4e5-f6a7-5b6c-9d0e-1f2a3b4c5d6e"), "1", "Admin", "ADMIN" });

            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "Id", "AccessFailedCount", "ApartmentId", "ApartmentNumber", "ConcurrencyStamp", "Email", "EmailConfirmed", "FullName", "IsManager", "LockoutEnabled", "LockoutEnd", "NormalizedEmail", "NormalizedUserName", "PasswordHash", "PhoneNumber", "PhoneNumberConfirmed", "SecurityStamp", "TwoFactorEnabled", "UserName" },
                values: new object[] { new Guid("a1b2c3d4-e5f6-4a5b-8c9d-0e1f2a3b4c5d"), 0, 9, "9", "1", "admin@siteyonetimi.com", true, "Onur Rozet", true, false, null, "ADMIN@SITEYONETIMI.COM", "9", "AQAAAAIAAYagAAAAEN5dvYMMZR6e5oz/fyUG3oXS13RiNNwFOvZf2iJQsQ+mham0nOtxYU0uBqjwHKIQhg==", null, false, "A7D5C6E8-B9F2-4E1D-8C9A-0B1C2D3E4F5G", false, "9" });

            migrationBuilder.InsertData(
                table: "AspNetUserRoles",
                columns: new[] { "RoleId", "UserId" },
                values: new object[] { new Guid("b2c3d4e5-f6a7-5b6c-9d0e-1f2a3b4c5d6e"), new Guid("a1b2c3d4-e5f6-4a5b-8c9d-0e1f2a3b4c5d") });
