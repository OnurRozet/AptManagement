...
public class ApartmentConfiguration : IEntityTypeConfiguration<AppUser>
{
    public void Configure(EntityTypeBuilder<AppUser> builder)
    {
        ...
        var managerApartment = new AppUser
        {
            Id = Guid.NewGuid(),
            ApartmentId = 9,
            ApartmentNumber = "Daire 9",
            FullName = "Onur Rözet",
            IsManager = true,
            UserName = "onur.rozet",
            NormalizedUserName = "ONUR.ROZET",
            Email = " ",
        };

        builder.HasData(managerApartment);
    }
}